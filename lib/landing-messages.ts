...
const ja: LandingMessages = {
  ...
  price: {
    ...
    rows: [
      ...
      { item: "団体時の配送会社の相見積もり", direct: "自社で各社に依頼", bondex: "BondEx" },
    ],
    flowDirect: "直接手配",
  ...
  contact: {
    heading: "試験運用は 1 件から。",
    body: {
      first: "契約もお支払いもオンラインで完結。サンプルバウチャーはこのサイトでご確認いただけます。",
      second: "取次業としての責任範囲は利用規約に明記しています。まずはお気軽にご相談ください。",
    },
    cta: "導入相談フォームへ",
    replyNote: "通常 1 営業日以内にご連絡します。",
  },
...
const en: LandingMessages = {
  ...
  price: {
    ...
    rows: [
      ...
      { item: "Comparing carrier quotes for groups", direct: "You handle it", bondex: "BondEx" },
    ],
...
const es: LandingMessages = {
  ...
  price: {
    ...
    rows: [
      ...
      { item: "Comparar presupuestos de transportistas para grupos", direct: "Usted se ocupa", bondex: "BondEx" },
    ],
...
const fr: LandingMessages = {
  ...
  price: {
    ...
    rows: [
      ...
      { item: "Comparaison des devis transporteurs pour les groupes", direct: "À votre charge", bondex: "BondEx" },
    ],
...
const zh: LandingMessages = {
  ...
  price: {
    ...
    rows: [
      ...
      { item: "团体行程的多家物流报价比较", direct: "自行处理", bondex: "BondEx" },
    ],
    flowDirect: "直接手配",
...
const it: LandingMessages = {
  ...
  price: {
    ...
    rows: [
      ...
      { item: "Confronto dei preventivi dei corrieri per i gruppi", direct: "A tuo carico", bondex: "BondEx" },
    ],
