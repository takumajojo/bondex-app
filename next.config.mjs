...
const csp = [
  ...
  // challenges.cloudflare.com = Turnstile ウィジェット(iframe)。
  "frame-src 'self' blob: https://js.stripe.com https://hooks.stripe.com https://m.stripe.network https://challenges.cloudflare.com",
